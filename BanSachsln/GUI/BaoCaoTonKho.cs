...
namespace GUI
{
    public partial class BaoCaoTonKho : Form
    {
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.BaoCaoTonKho.rdlc";
            Microsoft.Reporting.WinForms.ReportDataSource rdSource =
                        new Microsoft.Reporting.WinForms.ReportDataSource();
            rdSource.Name = "DataSet1";
            rdSource.Value = ds.BaoCaoTonKho;
            reportViewer1.LocalReport.DataSources.Add(rdSource);
            QuanLyBanSachTableAdapters.BaoCaoTonKhoTableAdapter datasetAdapter =
                       new QuanLyBanSachTableAdapters.BaoCaoTonKhoTableAdapter();
            datasetAdapter.ClearBeforeFill = true;
            datasetAdapter.Fill(ds.BaoCaoTonKho);
            ...
            reportViewer1.RefreshReport();
            //hiển thị
            reportViewer1.LocalReport.DisplayName = "TonKho";
        }
